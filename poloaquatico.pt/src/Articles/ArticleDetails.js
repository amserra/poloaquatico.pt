    ...
    <Container className="mt-5 page">
      ...
      <Row className="mt-5">
        ...
        <Col lg={7} className="mt-4">
          <p className="text-break font-weight-normal text-left">{slice(1)}</p>
        </Col>
      </Row>
      <Row className="mt-xl-4 mt-2">
        <Col xs={12} md={6}>
          <p className="text-break font-weight-normal text-left">{slice(2)}</p>
        </Col>
        <Col>
          <p className="text-break font-weight-normal text-left">{slice(3)}</p>
        </Col>
      </Row>
    </Container>
  );
